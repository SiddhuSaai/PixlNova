    ...
    return (
        <main className="relative bg-[var(--color-bg-primary)] text-white overflow-x-hidden">
            ...
            <section className="relative min-h-[90vh] flex items-end overflow-hidden">
                ...
                <div className="section-container relative z-10 pb-16 sm:pb-20 pt-32">
                    ...
                    >
                        ...
                        {/* Meta row */}
                        <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 sm:gap-6 text-white/35 text-[13px]">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {project.stack.slice(0, 4).map((tech) => (
                                    <span
                                        key={tech}
                                        className="px-2 py-0.5 text-[9px] font-medium tracking-wider uppercase rounded-full bg-white/[0.06] text-white/30"
                                    >
                                        {tech}
                                    </span>
                                ))}
            ...
            <motion.section
                ...
                className="py-10 sm:py-14 border-y border-white/[0.04] relative"
            >
                <div
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                        {project.results.map((r) => (
                            <motion.div key={r.metric} variants={scaleIn} className="text-center">
                                ...
                                <div className="text-[13px] font-semibold text-white/60 mb-0.5">{r.metric}</div>
                                <div className="text-[11px] text-white/25">{r.description}</div>
                            </motion.div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 lg:gap-20">
                        ...
                        <motion.div variants={fadeUp}>
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-white">The Challenge</h2>
                            </div>
                        ...
                        <motion.div variants={fadeUp}>
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-white">Our Solution</h2>
                            </div>
                            <p className="text-[15px] text-white/40 leading-[1.8]">
                                {project.solution}
                            </p>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                        {project.features.map((feature, i) => (
                            <motion.div
                                key={feature.title}
                                variants={fadeUp}
                                className="group relative rounded-2xl p-6 border border-white/[0.06] bg-white/[0.015] hover:bg-white/[0.03] hover:border-white/[0.12] transition-all duration-500"
                                whileHover={{
                            ...
                            >
                                ...
                                <p className="text-[13px] text-white/35 leading-relaxed group-hover:text-white/50 transition-colors">{feature.description}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            <motion.section
                ...
                className="py-16 sm:py-20 border-y border-white/[0.04]"
            >
                <div className="section-container">
                    <motion.div variants={fadeUp} className="text-center mb-10">
                        <h3 className="text-sm font-semibold text-white/25 uppercase tracking-widest mb-6">Tech Stack</h3>
                        <div className="flex flex-wrap justify-center gap-2.5 max-w-2xl mx-auto">
                            {project.stack.map((tech) => (
                                <motion.span
                                    ...
                                    className="px-4 py-2 rounded-xl border border-white/[0.06] bg-white/[0.02] text-[13px] font-medium text-white/50 hover:text-white hover:border-white/[0.15] transition-all duration-300 cursor-default"
                                >
                                    {tech}
                                </motion.span>
                            ))}
            ...
            {project.testimonial && (
                ...
                >
                    <div className="section-container max-w-4xl">
                        <motion.div
                            variants={fadeUp}
                            className="relative rounded-2xl border border-white/[0.06] p-8 sm:p-12"
                        ...
                        >
                            ...
                            <blockquote className="text-xl sm:text-2xl font-medium text-white/70 leading-relaxed mb-8">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[15px] font-semibold text-white">{project.testimonial.author}</p>
                                    <p className="text-[13px] text-white/35">{project.testimonial.role}</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
            ...
            <section className="py-20 sm:py-28 relative overflow-hidden">
                ...
                <div className="section-container text-center relative z-10">
                    <motion.div
                        ...
                        variants={stagger(0.1)}
                    >
                        <motion.p variants={fadeUp} className="text-sm text-white/25 uppercase tracking-widest mb-4">
                        ...
                        <motion.p variants={fadeUp} className="text-lg text-white/35 max-w-xl mx-auto mb-10">
                        ...
                        <motion.div variants={fadeUp} className="flex flex-wrap justify-center gap-4">
                            <MagneticButton>
                                <a
                                    href="/#contact"
                                    className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-[15px] font-semibold text-white transition-all duration-300"
                                    style={{
                            ...
                            <Link
                                href="/#portfolio"
                                className="inline-flex items-center gap-2 px-6 py-4 rounded-full border border-white/10 text-sm font-medium text-white/50 hover:text-white hover:border-white/20 transition-all"
                            >
                                <ArrowLeft className="w-4 h-4" />
                                View All Projects
                            </Link>
