                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-14 sm:mb-16">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/[0.06] bg-white/[0.02] mb-6">
                            ...
                            <span className="text-[11px] sm:text-[12px] text-white/35 font-medium uppercase tracking-widest">How We Work</span>
                        </div>
                                ...
                                >
                                    ...
                                    <motion.div
                                        className={`w-11 h-11 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${i <= active
                                            ...
                                            : "border-white/[0.06] bg-[var(--color-bg-primary)]"
                                            }`}
                                        style={i === active ? {
                                    ...
                                    >
                                        {i < active ? (
                                            ...
                                            <span
                                                className={`text-[12px] font-bold ${i === active ? "text-white" : "text-white/20"}`}
                                            >
                                                {step.number}
                                            </span>
                                        )}
                                    ...
                                    {/* Phase label */}
                                    <span className={`text-[9px] font-semibold tracking-[0.15em] uppercase transition-colors duration-300 ${i === active ? "text-white/60" : "text-white/15"
                                        }`}>
                                        {step.phase}
                                    </span>
                                </button>
                            ...
                            >
                                ...
                                <div className="relative z-10 p-8 sm:p-10 flex gap-12">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                <span className="text-[10px] text-white/25 font-semibold tracking-widest uppercase">Step {steps[active].number}</span>
                                                <h3 className="text-xl font-bold text-white -mt-0.5">{steps[active].title}</h3>
                                            </div>
                                        </div>
                                        <p className="text-white/40 text-[15px] leading-relaxed mb-6 max-w-lg">
                                            {steps[active].description}
                                        </p>
                                        <div className="flex items-center gap-2 text-[12px]">
                                            <span className="px-3 py-1 rounded-full border border-white/[0.08] bg-white/[0.03] text-white/30 font-medium">
                                    ...
                                    <div className="w-[280px] shrink-0">
                                        <p className="text-[10px] text-white/20 font-semibold uppercase tracking-widest mb-4">Deliverables</p>
                                        <div className="space-y-3">
                                            {steps[active].details.map((d, i) => (
                                                ...
                                                >
                                                    <div className="w-5 h-5 rounded-full flex items-center justify-center border border-white/[0.08] bg-white/[0.03]">
                                                        <CheckCircle2 className="w-3 h-3" style={{ color: steps[active].accent }} />
                                                    </div>
                                                    <span className="text-[13px] text-white/45 font-medium">{d}</span>
                                                </motion.div>
                                            ))}
                                        </div>
                                    </div>
                                ...
                                <div className="relative z-10 flex justify-between px-10 pb-8">
                                    <button
                                        ...
                                        disabled={active === 0}
                                        className="flex items-center gap-2 text-[12px] text-white/20 hover:text-white/50 disabled:opacity-20 disabled:cursor-not-allowed transition-colors"
                                    >
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 p-5">
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div
                                                    className="w-9 h-9 rounded-lg flex items-center justify-center border border-white/[0.08] shrink-0"
                                                    style={active === i ? {
                                                        color: step.accent,
                                                        background: step.glow,
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <span className="text-[9px] text-white/20 font-semibold uppercase tracking-widest">{step.phase}</span>
                                                    <h3 className="text-[15px] font-semibold text-white -mt-0.5 truncate">{step.title}</h3>
                                                </div>
                                                <span className="text-[10px] text-white/15 font-medium shrink-0">{step.duration}</span>
                                            </div>
                                            ...
                                            <AnimatePresence>
                                                {active === i && (
                                                    ...
                                                    >
                                                        <p className="text-[13px] text-white/35 leading-relaxed mt-3 mb-4">
                                                            {step.description}
                                                        </p>
                    ...
                    >
                        {[
                            ...
                            <div key={s.label} className="text-center">
                                ...
                                <span className="block text-[11px] text-white/20 font-medium mt-1 uppercase tracking-wider">{s.label}</span>
                            </div>
                        ))}
                    </motion.div>
                </motion.div>
