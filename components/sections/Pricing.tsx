                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/[0.06] bg-white/[0.02] mb-6">
                            ...
                            <span className="text-[11px] sm:text-[12px] text-white/35 font-medium uppercase tracking-widest">Simple Pricing</span>
                        </div>
                        ...
                        <motion.div variants={fadeUp} className="flex justify-center mb-8">
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/[0.06] bg-white/[0.02]">
                                ...
                                <span className="text-[12px] text-white/30">
                                    Prices for <span className="text-white/60 font-medium">{geo.country}</span> ({geo.currency})
                                </span>
                            </div>
                        </motion.div>
                    )}
                    ...
                    <AnimatePresence mode="wait">
                        <motion.p
                            ...
                            className="text-center text-[14px] text-white/25 mb-10 sm:mb-12"
                        >
                            {tabData.headline}
                        </motion.p>
                    </AnimatePresence>
                                ...
                                return (
                                    <div
                                        ...
                                        className={`group relative rounded-2xl overflow-hidden border transition-all duration-500 ${plan.popular
                                            ? "border-white/[0.12] bg-white/[0.03] md:scale-[1.03] shadow-[0_0_60px_-12px_rgba(139,92,246,0.15)]"
                                    ...
                                    >
                                        ...
                                        <div className="p-6 lg:p-7">
                                            ...
                                            <p className="text-[12px] text-white/25 mb-5">{plan.subtitle}</p>
                                            ...
                                            <div className="flex items-center gap-2 mb-6 text-[11px] text-white/20">
                                            ...
                                            <ul className="space-y-2.5 mb-7">
                                                {plan.features.map((feature) => (
                                                    <li key={feature} className="flex items-start gap-2.5">
                                                        <div className="w-4 h-4 rounded-full flex items-center justify-center bg-white/[0.04] shrink-0 mt-0.5">
                                            ...
                                            <a
                                                ...
                                                className={`flex items-center justify-center gap-2 w-full py-3 rounded-xl text-[13px] font-semibold transition-all duration-300 ${plan.popular
                                                    ? "bg-gradient-to-r from-[var(--color-brand-500)] to-[oklch(0.65_0.22_280)] text-white hover:shadow-[0_4px_24px_-4px_rgba(139,92,246,0.4)] hover:-translate-y-0.5"
                                                    : "border border-white/[0.08] text-white/60 hover:text-white hover:bg-white/[0.04] hover:border-white/[0.15]"
                                                    }`}
                                            >
                                                {plan.cta}
                    ...
                    >
                        {trustPoints.map((tp) => (
                            <div key={tp.text} className="flex items-center gap-2">
                                <tp.icon className="w-3.5 h-3.5 text-white/15" />
                                <span className="text-[11px] sm:text-[12px] text-white/20 font-medium">{tp.text}</span>
                            </div>
                        ))}
                    </motion.div>
