    ...
    return (
        ...
        >
            <Link href={`/projects/${project.id}`} className="block">
                <div className="group relative rounded-2xl overflow-hidden border border-white/[0.06] hover:border-white/[0.12] transition-all duration-500">
                    <div className="grid lg:grid-cols-[1.3fr_1fr]">
                        ...
                        <div className="relative overflow-hidden aspect-[16/10] lg:aspect-auto lg:min-h-[380px]">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-[oklch(0.08_0.01_280)] lg:block hidden" />
                            <div className="absolute inset-0 bg-gradient-to-t from-[oklch(0.08_0.01_280)] via-[oklch(0.08_0.01_280)/60%] to-transparent lg:hidden" />
                        ...
                        <div className="relative flex flex-col justify-center p-6 sm:p-8 lg:p-10">
                            ...
                            <div className="relative z-10">
                                <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 group-hover:text-white transition-colors tracking-tight">
                                    {project.title}
                                </h3>
                                <p className="text-[12px] sm:text-[13px] text-white/25 leading-relaxed mb-5 line-clamp-3">
                                    {project.description}
                                </p>
                                ...
                                <div className="grid grid-cols-2 gap-2 mb-5">
                                    {project.results.slice(0, 4).map((r) => (
                                        <div key={r.metric} className="rounded-lg bg-white/[0.02] border border-white/[0.04] px-3 py-2.5">
                                            <div className="text-[15px] font-bold tracking-tight" style={{ color: project.color }}>{r.value}</div>
                                            <div className="text-[9px] text-white/20 uppercase tracking-wider font-medium">{r.metric}</div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="flex flex-wrap gap-1.5 mb-5">
                                    {project.stack.slice(0, 5).map((tech) => (
                                        <span
                                            key={tech}
                                            className="px-2 py-0.5 text-[8px] font-medium tracking-wider rounded-full bg-white/[0.03] text-white/20 uppercase border border-white/[0.04]"
                                        >
                                            {tech}
                                        </span>
                                    ))}
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
                                    <span className="inline-flex items-center gap-1.5 text-[12px] font-medium text-white/40 group-hover:text-white/70 transition-colors">
                                        View Case Study
        ...
        >
            <Link href={`/projects/${project.id}`} className="block h-full">
                <motion.div
                    ...
                    className="group relative h-full rounded-2xl border border-white/[0.05] overflow-hidden cursor-pointer transition-all duration-500 hover:border-white/[0.12]"
                    whileHover={{
                ...
                >
                    ...
                    <div className="relative aspect-[16/11] overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-[oklch(0.08_0.01_280)] via-transparent to-transparent opacity-80" />
                            ...
                            <div className="flex gap-4">
                                {project.results.slice(0, 2).map((r) => (
                                    <div key={r.metric} className="text-center">
                                        ...
                                        <div className="text-[9px] text-white/40 uppercase tracking-wider">{r.metric}</div>
                                    </div>
                                ))}
                            </div>
                            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white text-[12px] font-medium">
                    ...
                    <div className="relative p-4 sm:p-5">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-start justify-between mb-1.5">
                                <h3 className="text-[15px] font-bold text-white/80 tracking-tight group-hover:text-white transition-colors">
                                    {project.title}
                                </h3>
                                <div className="w-6 h-6 rounded-full flex items-center justify-center bg-white/[0.03] border border-white/[0.06] opacity-0 group-hover:opacity-100 -translate-y-0.5 group-hover:translate-y-0 transition-all duration-300 shrink-0 ml-2">
                                    <ArrowUpRight className="w-3 h-3 text-white/50" />
                                </div>
                            </div>

                            <p className="text-[11px] text-white/20 leading-relaxed mb-3 line-clamp-2 group-hover:text-white/35 transition-colors duration-300">
                                {project.description}
                            </p>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex flex-wrap gap-1">
                                    {project.stack.slice(0, 3).map((tech) => (
                                        <span
                                            key={tech}
                                            className="px-1.5 py-0.5 text-[8px] font-medium tracking-wider rounded-md bg-white/[0.03] text-white/15 uppercase group-hover:text-white/30 group-hover:bg-white/[0.05] transition-colors duration-300"
                                        >
                                            {tech}
                                        </span>
                                    ))}
                                    {project.stack.length > 3 && (
                                        <span className="px-1.5 py-0.5 text-[8px] text-white/10 font-medium">
                                            +{project.stack.length - 3}
                                        </span>
                                    )}
                                </div>
                                <span className="text-[9px] text-white/10 font-medium flex items-center gap-1">
...
function TestimonialStrip({ project }: { project: Project }) {
    ...
    return (
        <motion.div
            ...
            className="col-span-full"
        >
            <div className="rounded-xl border border-white/[0.04] bg-white/[0.01] p-5 sm:p-6 flex gap-4 items-start">
                <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 bg-white/[0.03] border border-white/[0.06]">
                    <Quote className="w-3.5 h-3.5 text-white/15" />
                </div>
                <div>
                    <p className="text-[12px] sm:text-[13px] text-white/30 leading-relaxed italic mb-2">
                        &ldquo;{project.testimonial.quote}&rdquo;
                    </p>
                    <div className="flex items-center gap-2">
                        <span className="text-[11px] text-white/50 font-medium">{project.testimonial.author}</span>
                        <span className="text-white/10">·</span>
                        <span className="text-[10px] text-white/15">{project.testimonial.role}</span>
                    </div>
                </div>
            </div>
        </motion.div>
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/[0.06] bg-white/[0.02] mb-5">
                            ...
                            <span className="text-[10px] sm:text-[11px] text-white/30 font-medium uppercase tracking-widest">Our Work</span>
                        </div>
                        ...
                        <p className="mt-3 text-white/25 text-[14px] sm:text-[15px] leading-relaxed max-w-xl mx-auto">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className="relative z-10 flex items-center gap-1.5">
                                        {filter}
                                        <span className={`text-[9px] ${activeFilter === filter ? "text-white/30" : "text-white/10"}`}>
                                            {count}
                                        </span>
                                    </span>
                                </button>
                    ...
                    >
                        <a
                            href="#contact"
                            className="group inline-flex items-center gap-2 px-6 py-3 rounded-full border border-white/[0.06] bg-white/[0.02] text-[12px] font-medium text-white/35 hover:text-white/70 hover:border-white/[0.14] hover:bg-white/[0.04] transition-all duration-300"
                        >
